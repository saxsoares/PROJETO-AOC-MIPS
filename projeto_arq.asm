...
GetDir_right:
		bne, $t0, 100, GetDir_up		#Código do caractere 'd' em ASCII
		nop
		add $t6, $t6, 1
	...
	Right:	
		...
		nop
GetDir_up:
		bne, $t0, 119, GetDir_left		#Código do caractere 'w' em ASCII
		nop
		add $t6, $t6, 2
	...
	Up:		
		...
		nop
GetDir_left:
		bne, $t0, 97, GetDir_down		#Código do caractere 'a' em ASCII
		nop
		add $t6, $t6, 3
	...
	Left:	
		...
		nop
GetDir_down:
		bne, $t0, 115, Set_patametros_numeros		#Código do caractere 's' em ASCII
		nop
		add $t6, $t6, 4
		add $t8, $t8, 1
...
GetNumber_0:
		#bne, $t0, 48, GetNumber_1		#Código do caractere '0' em ASCII
		bne, $t0, 112, GetNumber_1		#Código do caractere 'p' em ASCII
		add $s1, $s1, $t7
		add $s1, $s1, 2068
		...
		nop
GetNumber_1:
		#bne, $t0, 49, GetNumber_2		#Código do caractere '0' em ASCII
		bne, $t0, 113, GetNumber_2		#Código do caractere 'q' em ASCII
		add $s1, $s1, $t7
		add $s1, $s1, 3092
		sw $s4, ($s1)			# Pinta o pixel da posicao s1
		sub $s1, $s1, 1020
		...
		nop
GetNumber_2:
		#bne, $t0, 50, GetNumber_3		#Código do caractere '0' em ASCII
		bne, $t0, 120, GetNumber_3		#Código do caractere 'x' em ASCII
		add $s1, $s1, $t7
		add $s1, $s1, 3088
		sw $s4, ($s1)			# Pinta o pixel da posicao s1
		sub $s1, $s1, 1020
		...
		nop
GetNumber_3:
		#bne, $t0, 51, GetNumber_4		#Código do caractere '0' em ASCII
		bne, $t0, 101, GetNumber_4		#Código do caractere 'e' em ASCII
		add $s1, $s1, $t7
		add $s1, $s1, 3088
		sw $s4, ($s1)			# Pinta o pixel da posicao s1
		sub $s1, $s1, 1020
		...
		nop
GetNumber_4:
		#bne, $t0, 52, GetNumber_5		#Código do caractere '0' em ASCII
		bne, $t0, 114, GetNumber_5		#Código do caractere 'r' em ASCII
		add $s1, $s1, $t7
		add $s1, $s1, 8220
		sw $s4, ($s1)			# Pinta o pixel da posicao s1
		sub $s1, $s1, 1024
		...
		nop
GetNumber_5:
		#bne, $t0, 53, GetNumber_6		#Código do caractere '0' em ASCII
		bne, $t0, 116, GetNumber_6		#Código do caractere 't' em ASCII
		add $s1, $s1, $t7
		add $s1, $s1, 2064
		sw $s4, ($s1)			# Pinta o pixel da posicao s1
		add $s1, $s1, 4
		...
		nop
GetNumber_6:
		#bne, $t0, 54, GetNumber_7		#Código do caractere '0' em ASCII
		bne, $t0, 121, GetNumber_7		#Código do caractere 'y' em ASCII
		add $s1, $s1, $t7
		add $s1, $s1, 3104
		sw $s4, ($s1)			# Pinta o pixel da posicao s1
		sub $s1, $s1, 1028
		...
		nop
GetNumber_7:
		#bne, $t0, 55, GetNumber_8		#Código do caractere '0' em ASCII
		bne, $t0, 117, GetNumber_8		#Código do caractere 'u' em ASCII
		add $s1, $s1, $t7
		add $s1, $s1, 2064
		sw $s4, ($s1)			# Pinta o pixel da posicao s1
		add $s1, $s1, 4
		...
		nop
GetNumber_8:
		#bne, $t0, 56, GetNumber_9		#Código do caractere '0' em ASCII
		bne, $t0, 105, GetNumber_9		#Código do caractere 'i' em ASCII
		add $s1, $s1, $t7
		add $s1, $s1, 2068
		sw $s4, ($s1)			# Pinta o pixel da posicao s1
		add $s1, $s1, 4
		...
		nop
GetNumber_9:
		#bne, $t0, 57, GetDir_done		#Código do caractere '0' em ASCII
		bne, $t0, 111, Digito_Mais		#Código do caractere 'o' em ASCII
		add $s1, $s1, $t7
		add $s1, $s1, 2068
		sw $s4, ($s1)			# Pinta o pixel da posicao s1
		add $s1, $s1, 4
...
Digito_Mais:
		#bne, $t0, 57, GetDir_done		#Código do caractere '0' em ASCII
		bne, $t0, 107, Digito_Menos		#Código do caractere 'k' em ASCII
		add $s1, $s1, $t7
		add $s1, $s1, 3096
		sw $s4, ($s1)			# Pinta o pixel da posicao s1
		add $s1, $s1, 1024
...
Digito_Menos:
		#bne, $t0, 57, GetDir_done		#Código do caractere '0' em ASCII
		bne, $t0, 108, Digito_Multiplicacao	#Código do caractere 'l' em ASCII
		add $s1, $s1, $t7
		add $s1, $s1, 5136
		sw $s4, ($s1)			# Pinta o pixel da posicao s1
		add $s1, $s1, 4
...
Digito_Multiplicacao:
		#bne, $t0, 57, GetDir_done		#Código do caractere '0' em ASCII
		bne, $t0, 109, Digito_Divisao		#Código do caractere 'm' em ASCII
		add $s1, $s1, $t7
		add $s1, $s1, 3088
		sw $s4, ($s1)			# Pinta o pixel da posicao s1
		add $s1, $s1, 1028
...
Digito_Divisao:
		#bne, $t0, 57, GetDir_done		#Código do caractere '0' em ASCII
		bne, $t0, 110, GetDir_done		#Código do caractere 'n' em ASCII
		add $s1, $s1, $t7
		add $s1, $s1, 7184
		sw $s4, ($s1)			# Pinta o pixel da posicao s1
		sub $s1, $s1, 1020

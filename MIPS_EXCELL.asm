...
.macro DrawVLine (%color, %x)
		...
		addi $t0, $t0, 7168		# This is for Vertical lines starts after 14 horizontal line ( espa�o em branco em cima)
		add $t0, $t0, $gp
DVL_Loop:
...
Backspace:
		...
		sub $t2, $t2, 4
		move $a1, $t2			# padroniza��o: passar parametros pelos registradores $a
		BackSpaceM ($a1)
